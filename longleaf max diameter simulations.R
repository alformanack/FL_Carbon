...
for (o in 1:10){
  ...
  predict.d[o,1]<-max(Diameter[observed.a, which (Diameter[observed.a,]>=5)])
...
for (o in 1:10){
  ...
  # save average modeled diameter
  predict.d[o,1]<-max(Diameter[observed.a, ])
...
#after
growth<-(10^(0.9691031 - 0.009259*CN_SCALE + 0.011340*CN_SCALE*aridity - 0.977477*aridity))*(0.5559042*age[i,j]^(-0.4440958))

age<- round((10^(-1.743292 + 0.01665575*CN_SCALE - 0.0203992*CN_SCALE*aridity + 1.758355*aridity))*(envdata[1,3]^(1.798871)))
...
# set stand age and density
plot_density<-round(envdata[1,2])
observed.a<-round((10^(-1.743292 + 0.01665575*CN_SCALE - 0.0203992*CN_SCALE*aridity + 1.758355*aridity))*(envdata[1,3]^(1.798871)))
predict.tasb<-matrix(nrow = 10, ncol = 1,0)
predict.d<-matrix(nrow = 10, ncol = 1,0)
...
for (o in 1:10){
  ...
  # initialize the diameter for the first year
  Diameter[1,]<-(10^(0.9691031 - 0.009259*CN_SCALE + 0.011340*CN_SCALE*aridity - 0.977477*aridity))*(0.5559042*1^(-0.4440958))
...
# set stand age and density
plot_density<-round(envdata[2,2])
observed.a<-round((10^(-1.743292 + 0.01665575*CN_SCALE - 0.0203992*CN_SCALE*aridity + 1.758355*aridity))*(envdata[2,3]^(1.798871)))
predict.tasb<-matrix(nrow = 10, ncol = 1,0)
predict.d<-matrix(nrow = 10, ncol = 1,0)
...
# set stand age and density
plot_density<-round(envdata[3,2])
observed.a<-round((10^(-1.743292 + 0.01665575*CN_SCALE - 0.0203992*CN_SCALE*aridity + 1.758355*aridity))*(envdata[3,3]^(1.798871)))
predict.tasb<-matrix(nrow = 10, ncol = 1,0)
predict.d<-matrix(nrow = 10, ncol = 1,0)
...
# set stand age and density
plot_density<-round(envdata[4,2])
observed.a<-round((10^(-1.743292 + 0.01665575*CN_SCALE - 0.0203992*CN_SCALE*aridity + 1.758355*aridity))*(envdata[4,3]^(1.798871)))
predict.tasb<-matrix(nrow = 10, ncol = 1,0)
predict.d<-matrix(nrow = 10, ncol = 1,0)
...
# set stand age and density
plot_density<-round(envdata[5,2])
observed.a<-round((10^(-1.743292 + 0.01665575*CN_SCALE - 0.0203992*CN_SCALE*aridity + 1.758355*aridity))*(envdata[5,3]^(1.798871)))
predict.tasb<-matrix(nrow = 10, ncol = 1,0)
predict.d<-matrix(nrow = 10, ncol = 1,0)
...
# set stand age and density
plot_density<-round(envdata[6,2])
observed.a<-round((10^(-1.743292 + 0.01665575*CN_SCALE - 0.0203992*CN_SCALE*aridity + 1.758355*aridity))*(envdata[6,3]^(1.798871)))
predict.tasb<-matrix(nrow = 10, ncol = 1,0)
predict.d<-matrix(nrow = 10, ncol = 1,0)
...
# set stand age and density
plot_density<-round(envdata[7,2])
observed.a<-round((10^(-1.743292 + 0.01665575*CN_SCALE - 0.0203992*CN_SCALE*aridity + 1.758355*aridity))*(envdata[7,3]^(1.798871)))
predict.tasb<-matrix(nrow = 10, ncol = 1,0)
predict.d<-matrix(nrow = 10, ncol = 1,0)
...
# set stand age and density
plot_density<-round(envdata[8,2])
observed.a<-round((10^(-1.743292 + 0.01665575*CN_SCALE - 0.0203992*CN_SCALE*aridity + 1.758355*aridity))*(envdata[8,3]^(1.798871)))
predict.tasb<-matrix(nrow = 10, ncol = 1,0)
predict.d<-matrix(nrow = 10, ncol = 1,0)
...
# set stand age and density
plot_density<-round(envdata[9,2])
observed.a<-round((10^(-1.743292 + 0.01665575*CN_SCALE - 0.0203992*CN_SCALE*aridity + 1.758355*aridity))*(envdata[9,3]^(1.798871)))
predict.tasb<-matrix(nrow = 10, ncol = 1,0)
predict.d<-matrix(nrow = 10, ncol = 1,0)
...
# set stand age and density
plot_density<-round(envdata[10,2])
observed.a<-round((10^(-1.743292 + 0.01665575*CN_SCALE - 0.0203992*CN_SCALE*aridity + 1.758355*aridity))*(envdata[10,3]^(1.798871)))
predict.tasb<-matrix(nrow = 10, ncol = 1,0)
predict.d<-matrix(nrow = 10, ncol = 1,0)
...
# set stand age and density
plot_density<-round(envdata[11,2])
observed.a<-round((10^(-1.743292 + 0.01665575*CN_SCALE - 0.0203992*CN_SCALE*aridity + 1.758355*aridity))*(envdata[11,3]^(1.798871)))
predict.tasb<-matrix(nrow = 10, ncol = 1,0)
predict.d<-matrix(nrow = 10, ncol = 1,0)
...
# set stand age and density
plot_density<-round(envdata[12,2])
observed.a<-round((10^(-1.743292 + 0.01665575*CN_SCALE - 0.0203992*CN_SCALE*aridity + 1.758355*aridity))*(envdata[12,3]^(1.798871)))
predict.tasb<-matrix(nrow = 10, ncol = 1,0)
predict.d<-matrix(nrow = 10, ncol = 1,0)
...
# set stand age and density
plot_density<-round(envdata[13,2])
observed.a<-round((10^(-1.743292 + 0.01665575*CN_SCALE - 0.0203992*CN_SCALE*aridity + 1.758355*aridity))*(envdata[13,3]^(1.798871)))
predict.tasb<-matrix(nrow = 10, ncol = 1,0)
predict.d<-matrix(nrow = 10, ncol = 1,0)
...
# set stand age and density
plot_density<-round(envdata[14,2])
observed.a<-round((10^(-1.743292 + 0.01665575*CN_SCALE - 0.0203992*CN_SCALE*aridity + 1.758355*aridity))*(envdata[14,3]^(1.798871)))
predict.tasb<-matrix(nrow = 10, ncol = 1,0)
predict.d<-matrix(nrow = 10, ncol = 1,0)
...
# set stand age and density
plot_density<-round(envdata[15,2])
observed.a<-round((10^(-1.743292 + 0.01665575*CN_SCALE - 0.0203992*CN_SCALE*aridity + 1.758355*aridity))*(envdata[15,3]^(1.798871)))
predict.tasb<-matrix(nrow = 10, ncol = 1,0)
predict.d<-matrix(nrow = 10, ncol = 1,0)
...
# set stand age and density
plot_density<-round(envdata[16,2])
observed.a<-round((10^(-1.743292 + 0.01665575*CN_SCALE - 0.0203992*CN_SCALE*aridity + 1.758355*aridity))*(envdata[16,3]^(1.798871)))
predict.tasb<-matrix(nrow = 10, ncol = 1,0)
predict.d<-matrix(nrow = 10, ncol = 1,0)
...
# set stand age and density
plot_density<-round(envdata[17,2])
observed.a<-round((10^(-1.743292 + 0.01665575*CN_SCALE - 0.0203992*CN_SCALE*aridity + 1.758355*aridity))*(envdata[17,3]^(1.798871)))
predict.tasb<-matrix(nrow = 10, ncol = 1,0)
predict.d<-matrix(nrow = 10, ncol = 1,0)
...
# set stand age and density
plot_density<-round(envdata[18,2])
observed.a<-round((10^(-1.743292 + 0.01665575*CN_SCALE - 0.0203992*CN_SCALE*aridity + 1.758355*aridity))*(envdata[18,3]^(1.798871)))
predict.tasb<-matrix(nrow = 10, ncol = 1,0)
predict.d<-matrix(nrow = 10, ncol = 1,0)
...
# set stand age and density
plot_density<-round(envdata[19,2])
observed.a<-round((10^(-1.743292 + 0.01665575*CN_SCALE - 0.0203992*CN_SCALE*aridity + 1.758355*aridity))*(envdata[19,3]^(1.798871)))
predict.tasb<-matrix(nrow = 10, ncol = 1,0)
predict.d<-matrix(nrow = 10, ncol = 1,0)
...
# set stand age and density
plot_density<-round(envdata[20,2])
observed.a<-round((10^(-1.743292 + 0.01665575*CN_SCALE - 0.0203992*CN_SCALE*aridity + 1.758355*aridity))*(envdata[20,3]^(1.798871)))
predict.tasb<-matrix(nrow = 10, ncol = 1,0)
predict.d<-matrix(nrow = 10, ncol = 1,0)
...
model.2<-lm(data = final_list, log10(Observed_Diameter/Modeled_Diameter)~Temperature)
summary(model.2)

model.3<-lm(data = final_list, Modeled_Biomass~Observed_Biomass)

plot(data = final_list, Observed_Diameter~Modeled_Diameter, xlim = c(0,17), ylim = c(0,17), xlab="Modeled DBH (in)", ylab="Observed DBH (in)",
     main = "After parameter correction (with corecting age)", col.axis="#027368", col="#75BFBF", pch=16, type="p") + abline(0,1, col="#048ABF")
text(Observed_Diameter~Modeled_Diameter, labels=rownames(final_list),data=final_list, cex=0.9, font=2, pos=4)
arrows(final_list$Modeled_Diameter-sdev.dbh, final_list$Observed_Diameter, final_list$Modeled_Diameter+sdev.dbh, final_list$Observed_Diameter, length=0.05, angle=90, code=3)
...
setwd("C:/Users/Alicia/Documents/GitHub/FL_Carbon")
envdata<-read.csv("longleaf_boyd_tract.csv", header=T, sep=",")
...
# set parameters for growth equation
aridity<-envdata[1,6]*0.0001

temp<-envdata[1,7]

C_AVG<-((envdata[1,8]/10)*(1/3))+((envdata[1,9]/10)*(2/3))

N_AVG<-((envdata[1,10]/100)*(1/3))+((envdata[1,11]/100)*(2/3))
