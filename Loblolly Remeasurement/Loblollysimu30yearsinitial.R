...
for (s in 1:8){
  ...
  for (o in 1:300){
    ...
    Diameter[1,]<-(10^(initial.par[o,1] + initial.par[o,3]*temp + initial.par[o,4]*temp*aridity + 
                   initial.par[o,2]*aridity))*(initial.par[o,5]*1^(initial.par[o,5]-1))
...
save(AGB_Loblolly, file = "C:/Users/Alicia/Documents/GitHub/FL_Carbon/Loblolly Remeasurement/SimuLoblolly30yrsAGBinitial.rdata")
save(DBH_Loblolly, file = "C:/Users/Alicia/Documents/GitHub/FL_Carbon/Loblolly Remeasurement/SimuLoblolly30yrsDBHinitial.rdata")
