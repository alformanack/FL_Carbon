...
pmin <- c()
pmax <- c()
pmin[1] <- 0.0; pmin[2] <- -.05;pmin[3] <- 0.0
pmax[1] <- 0.5; pmax[2] <- 0.0; pmax[3] <- 0.0005


par.name <- c("a1","b1","b2")
p_op <- c(1.329e-01, -1.075e-02,1.401e-04)
...
save.image(file ="//net.ucf.edu/COS/Profiles/al117862/Documents/GitHub/FL_Carbon/Loblolly Remeasurement/LoblollyCalibrationMOrtOnly4.4.21.Rdata")
# 
# dev.off()
# par(mfrow=c(1,1))
# 
