...
for (o in 1:10){
  ...
  for (j in 1:plot_density){ # specify tree per hectare
    ...
    for (i in 2:observed.a){ # specify how long to run the simulation (years)
      ...
      else if (Diameter[i,j]>3.94 & Diameter[i,j]<=7.97){M<-rbinom(1,1,(.028/4))}
      else if (Diameter[i,j]>7.97 & Diameter[i,j]<=11.81){M<-rbinom(1,1,(.008/4))}
      else if (Diameter[i,j]>11.81 & Diameter[i,j]<=15.75){M<-rbinom(1,1,(.014/4))}
      else if (Diameter[i,j]>15.75 & Diameter[i,j]<=19.69){M<-rbinom(1,1,(.024/4))}
      else if (Diameter[i,j]>19.69 & Diameter[i,j]<=23.62){M<-rbinom(1,1,(.041/4))}
      else if (Diameter[i,j]>23.62 & Diameter[i,j]<=27.56){M<-rbinom(1,1,(.055/4))}
      else if (Diameter[i,j]>27.56){M<-rbinom(1,1,(0.118/4))}
...
model.2<-lm(data = final_list_longleaf, log10(Observed_Diameter/Modeled_Diameter)~log10(Age))
summary(model.2)
...
plot(data = final_list_longleaf, Observed_Biomass~Modeled_Biomass, xlim = c(0,17000), ylim = c(0,17000), col = "#75BFBF", xlab="Modeled", ylab="Observed", main ="Tree Carbon (gC/m^2)",
...
for (o in 1:10){
  ...
  for (j in 1:plot_density){ # specify tree per hectare
    ...
    for (i in 2:observed.a){ # specify how long to run the simulation (years)
      ...
      # Mortality based on diameter class
      if (Diameter[i,j]<=3.94){ M<- rbinom(1,1,(.162/4))}
      else if (Diameter[i,j]>3.94 & Diameter[i,j]<=7.97){M<-rbinom(1,1,(.028/8))}
      else if (Diameter[i,j]>7.97 & Diameter[i,j]<=11.81){M<-rbinom(1,1,(.008/8))}
      else if (Diameter[i,j]>11.81 & Diameter[i,j]<=15.75){M<-rbinom(1,1,(.014/8))}
      else if (Diameter[i,j]>15.75 & Diameter[i,j]<=19.69){M<-rbinom(1,1,(.024/8))}
      else if (Diameter[i,j]>19.69 & Diameter[i,j]<=23.62){M<-rbinom(1,1,(.041/8))}
      else if (Diameter[i,j]>23.62 & Diameter[i,j]<=27.56){M<-rbinom(1,1,(.055/8))}
      else if (Diameter[i,j]>27.56){M<-rbinom(1,1,(0.118/8))}
