...
for (o in 1:10){
  ...
  for (j in 1:plot_density){ # specify tree per hectare
    ...
    for (i in 2:observed.a){ # specify how long to run the simulation (years)
      ...
      if (Diameter[i,j]<=1.57021857){ M<- rbinom(1,1,(0.474045802/8))}
      else if (Diameter[i,j]>1.57021857 & Diameter[i,j]<=1.936984951){M<-rbinom(1,1,(0.378625954/8))}
      else if (Diameter[i,j]>1.936984951 & Diameter[i,j]<=2.280828434){M<-rbinom(1,1,(0.297709924/8))}
      else if (Diameter[i,j]>2.280828434 & Diameter[i,j]<=2.808055107){M<-rbinom(1,1,(0.232824427/8))}
      else if (Diameter[i,j]>2.808055107 & Diameter[i,j]<=3.679125262){M<-rbinom(1,1,(0.165648855/8))}
      else if (Diameter[i,j]>3.679125262 & Diameter[i,j]<=4.687732811){M<-rbinom(1,1,(0.101526718/8))}
      else if (Diameter[i,j]>4.687732811 & Diameter[i,j]<=6.429873122){M<-rbinom(1,1,(0.049618321/8))}
      else if (Diameter[i,j]>6.429873122 & Diameter[i,j]<=8.355396623){M<-rbinom(1,1,(0.020610687/8))}
      else if (Diameter[i,j]>8.355396623 & Diameter[i,j]<=10.6935323){M<-rbinom(1,1,(0.005343511/8))}
      else if (Diameter[i,j]>10.6935323){M<-rbinom(1,1,(0.003816794/8))}
...
text(Observed_Diameter~Modeled_Diameter, labels=rownames(final_list_slash),data=final_list_slash, cex=0.9, font=2, pos=4)
...
plot(data = final_list_slash, Observed_Biomass~Modeled_Biomass, xlim = c(0,19000), ylim = c(0,19000), col = "#75BFBF", xlab="Modeled", ylab="Observed", main ="Tree Carbon (gC/m^2)",
