...
pmin[1] <- 0.0;pmin[2] <-  0.00;pmin[3] <-  0.00;pmin[4] <- 0;pmin[5] <-  0.0;pmin[6] <- 0.0;pmin[7] <- -0.9;pmin[8] <- 0;pmin[9] <- -0.1
pmax[1] <- 4.1;pmax[2] <-  0.02;pmax[3] <-  0.04;pmax[4] <- 5;pmax[5] <-  0.05;pmax[6] <- 1.0;pmax[7] <- -0.1;pmax[8] <- 1.2;pmax[9] <- 0.0
